...
""" Tokenization class for model MEGA."""
...
class MEGATokenizer(PreTrainedTokenizer):
    """
    Construct a MEGA tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).
